...
/**
 * <p>
 * Java class for CuentaCarteraType complex type.
 *
 * <p>
 ...
 *                   &lt;/simpleType>
 *                 &lt;/attribute>
 *                 &lt;attribute name="tipoObligacion">
 *                   &lt;simpleType>
 *                     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}string">
 *                     &lt;/restriction>
 *                   &lt;/simpleType>
 *                 &lt;/attribute>
 *                 &lt;attribute name="tipoContrato" use="required">
 *                   &lt;simpleType>
 *                     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}string">
 *                     &lt;/restriction>
 *                   &lt;/simpleType>
 ...
 *                 &lt;attribute name="mesesPermanencia" type="{http://www.w3.org/2001/XMLSchema}short" />
 *                 &lt;attribute name="fechaPermanencia" type="{http://www.w3.org/2001/XMLSchema}date" />
 *                 &lt;attribute name="calidadDeudor" use="required" type="{http://www.w3.org/2001/XMLSchema}string" />
 *                 &lt;attribute name="garantia" type="{http://www.w3.org/2001/XMLSchema}string" />
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 *         &lt;/element>
 ...
 *                             &lt;/simpleType>
 *                           &lt;/attribute>
 *                           &lt;attribute name="meses" use="required" type="{http://www.w3.org/2001/XMLSchema}int" />
 *                           &lt;attribute name="fecha" use="required" type="{http://www.w3.org/2001/XMLSchema}date" />
 *                         &lt;/restriction>
 *                       &lt;/complexContent>
 *                     &lt;/complexType>
...
public class CuentaCarteraType {
     ...
     *
     * @return possible object is {@link CuentaCarteraType.Caracteristicas }
     *
     */
    public CuentaCarteraType.Caracteristicas getCaracteristicas() {
     ...
     *
     * @param value allowed object is {@link CuentaCarteraType.Caracteristicas }
     *
     */
    public void setCaracteristicas(CuentaCarteraType.Caracteristicas value) {
     ...
     *
     * @return possible object is {@link CuentaCarteraType.Valores }
     *
     */
     ...
     *
     * @param value allowed object is {@link CuentaCarteraType.Valores }
     *
     */
     ...
     *
     * @return possible object is {@link CuentaCarteraType.Estados }
     *
     */
    public CuentaCarteraType.Estados getEstados() {
        return estados;
    }
     ...
     *
     * @param value allowed object is {@link CuentaCarteraType.Estados }
     *
     */
    public void setEstados(CuentaCarteraType.Estados value) {
        this.estados = value;
    }
    ...
    public static class Caracteristicas {
        ...
        @XmlAttribute
        protected Short mesesPermanencia;
        @XmlAttribute
        @XmlSchemaType(name = "date")
        protected XMLGregorianCalendar fechaPermanencia;
        @XmlAttribute(required = true)
        ...
        /**
         * Gets the value of the mesesPermanencia property.
         *
         * @return possible object is {@link Short }
         *
         */
        ...
        /**
         * Sets the value of the mesesPermanencia property.
         *
         * @param value allowed object is {@link Short }
         *
         */
        public void setMesesPermanencia(Short value) {
            this.mesesPermanencia = value;
        }

        /**
         * Gets the value of the fechaPermanencia property.
         *
         * @return possible object is {@link XMLGregorianCalendar }
         *
         */
        public XMLGregorianCalendar getFechaPermanencia() {
            return fechaPermanencia;
        }

        /**
         * Sets the value of the fechaPermanencia property.
         *
         * @param value allowed object is {@link XMLGregorianCalendar }
         *
         */
        public void setFechaPermanencia(XMLGregorianCalendar value) {
            this.fechaPermanencia = value;
        }
    ...
    public static class Estados {
        ...
        protected CuentaCarteraType.Estados.EstadoCuenta estadoCuenta;
        @XmlElement(name = "EstadoOrigen", required = true)
        protected CuentaCarteraType.Estados.EstadoOrigen estadoOrigen;
        @XmlElement(name = "EstadoPago", required = true)
        protected CuentaCarteraType.Estados.EstadoPago estadoPago;

        /**
         * Gets the value of the estadoCuenta property.
         *
         * @return possible object is
         *     {@link CuentaCarteraType.Estados.EstadoCuenta }
         *
         */
        public CuentaCarteraType.Estados.EstadoCuenta getEstadoCuenta() {
            return estadoCuenta;
        }
         ...
         *
         */
        public void setEstadoCuenta(CuentaCarteraType.Estados.EstadoCuenta value) {
         ...
         *
         * @return possible object is
         *     {@link CuentaCarteraType.Estados.EstadoOrigen }
         *
         */
        public CuentaCarteraType.Estados.EstadoOrigen getEstadoOrigen() {
            return estadoOrigen;
        }
         ...
         *
         */
        public void setEstadoOrigen(CuentaCarteraType.Estados.EstadoOrigen value) {
         ...
         *
         * @return possible object is
         *     {@link CuentaCarteraType.Estados.EstadoPago }
         *
         */
        public CuentaCarteraType.Estados.EstadoPago getEstadoPago() {
            return estadoPago;
        }
         ...
         *
         */
        public void setEstadoPago(CuentaCarteraType.Estados.EstadoPago value) {
    ...
    public static class Valores {
        ...
        protected CuentaCarteraType.Valores.Valor valor;

        /**
         * Gets the value of the valor property.
         *
         * @return possible object is {@link CuentaCarteraType.Valores.Valor }
         *
         */
        public CuentaCarteraType.Valores.Valor getValor() {
            return valor;
        }
         ...
         *
         * @param value allowed object is
         *     {@link CuentaCarteraType.Valores.Valor }
         *
         */
        public void setValor(CuentaCarteraType.Valores.Valor value) {
            this.valor = value;
        }
